...
def get_survey_dates(survey_info_in):
    ...
    cohort_program_or_hybrid_start_date = datetime.strftime(datetime.strptime((prior_year + '-10-01'), "%Y-%m-%d"),
                                                            "%Y-%m-%d")
    cohort_program_or_hybrid_end_date = datetime.strftime(datetime.strptime((prior_year + '-10-31'), "%Y-%m-%d"),
                                                          "%Y-%m-%d")
    ...
    department_of_defense_start_date = datetime.strftime(datetime.strptime((prior_year + '-10-01'), "%Y-%m-%d"),
                                                         "%Y-%m-%d")
