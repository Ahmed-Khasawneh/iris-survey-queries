...
from (
    select 'D' PART,
            ...
            ROUND(coalesce(SUM(case when cohortstu.yearType = 'CY' then cohortstu.totagroup3TotallAid end), 0)) FIELD14_1, --Total aid for Group 3 current year, 0-999999999999
