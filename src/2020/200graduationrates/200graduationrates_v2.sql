...
FILE NAME: 		200% Graduation Rates v2 (G22)
FILE DESC:      200% Graduation Rates for less-than-4-year institutions reporting on a fall cohort (academic reporters)
AUTHOR:         akhasawneh
CREATED:        20200129
...
----------- 		--------------------	-------------   	------------------------------------------------- 
20200129	        akhasawneh				                    Initial version (runtime: 6m, 10s (prod)/ 6m, 17(test)



- COHORT - Only cares about Bachelor's degree seeking/full time/first time in the cohort.
    - Academic Reporters - as of October 15, 2016 (or the institution's official fall reporting date) 
    - Program Reporters - between September 1, 2016 and August 31, 2017
    -For institutions that do not determine degree intent upon entry, this should include any students whose intent was not known.
- REPORTING PERIOD - July 01, 2016 through August 31, 2020.
--of the cohort group it wants:

line 8, report the number of students who completed a program (including eligible transfer-preparatory programs; as outlined in the instructions for the Graduation Rates survey component) within the period of 151% to 200% of normal time.
...
select '2021' surveyYear, 
	...
	CAST('2016-07-01' AS DATE) reportingDateStart,
	CAST('2020-08-31' AS DATE) reportingDateEnd,
	'201610' termCode, --Fall 2014
	'1' partOfTermCode, 
	CAST('2016-09-10' AS DATE) censusDate,
    ...
    CAST('2019-08-31' as DATE) midStatusDate, --(same as Grad Rates) "150% of normal time to completion or August 31, 2019 (whichever was earlier)"
    CAST('2020-08-31' as DATE) latestStatusDate, --151% - 200% (September 1, 2019 through August 31, 2020)
--***** start survey-specific mods
	CAST('2016-10-15' AS DATE) cohortDateEnd, --as of October 15, 2016 (or the institution's official fall reporting date) 
    'Fall' surveySection
...
select '2021' surveyYear, 
	...
	CAST('2016-07-01' AS DATE) reportingDateStart,
	CAST('2020-08-31' AS DATE) reportingDateEnd,
	'201530' termCode, --Fall 2014
	'1' partOfTermCode, 
	CAST('2016-08-01' AS DATE) censusDate,
	'M' genderForUnknown,   --'Valid values: M = Male, F = Female; Default value (if no record or null value): M'
	'F' genderForNonBinary, --'Valid values: M = Male, F = Female; Default value (if no record or null value): F'
    'CR' instructionalActivityType, --'Valid values: CR = Credit, CL = Clock, B = Both; Default value (if no record or null value): CR'
    'A' acadOrProgReporter, --'Valid values: A = Academic, H = Hybrid, P = Program; Default value (if no record or null value): A'
...
select '1415' surveyYear, 
    ...
    null repPeriodTag4,
	CAST('9999-09-09' as DATE) snapshotDate,  
	CAST('2010-07-01' AS DATE) reportingDateStart,
	CAST('2014-08-31' AS DATE) reportingDateEnd,
	'201010' termCode, --Fall 2006
	'1' partOfTermCode, 
	CAST('2010-08-01' AS DATE) censusDate,
	'M' genderForUnknown,   --'Valid values: M = Male, F = Female; Default value (if no record or null value): M'
	'F' genderForNonBinary, --'Valid values: M = Male, F = Female; Default value (if no record or null value): F'
    'CR' instructionalActivityType, --'Valid values: CR = Credit, CL = Clock, B = Both; Default value (if no record or null value): CR'
    'A' acadOrProgReporter, --'Valid values: A = Academic, H = Hybrid, P = Program; Default value (if no record or null value): A'
    'U' publicOrPrivateInstitution, --'Valid values: U = Public, R = Private; Default value (if no record or null value): U'
    CAST('2010-08-31' as DATE) earliestStatusDate, --BS4YrDate
    CAST('2013-08-31' as DATE) midStatusDate, --(same as Grad Rates) "150% of normal time to completion or August 31, 2013 (whichever was earlier)"
    CAST('2014-08-31' as DATE) latestStatusDate,  --151% - 200% (September 1, 2013 through August 31, 2014)
--***** start survey-specific mods
	CAST('2010-10-15' AS DATE) cohortDateEnd, --as of October 15, 2010 (or the institution's official fall reporting date) 
    'Fall' surveySection
--***** end survey-specific mods
...
select '1415' surveyYear, 
	...
	CAST('2010-07-01' AS DATE) reportingDateStart,
	CAST('2014-08-31' AS DATE) reportingDateEnd,
	'200930' termCode, --Fall 2006
	'1' partOfTermCode, 
	CAST('2010-06-15' AS DATE) censusDate,
	'M' genderForUnknown,   --'Valid values: M = Male, F = Female; Default value (if no record or null value): M'
	'F' genderForNonBinary, --'Valid values: M = Male, F = Female; Default value (if no record or null value): F'
    'CR' instructionalActivityType, --'Valid values: CR = Credit, CL = Clock, B = Both; Default value (if no record or null value): CR'
    'A' acadOrProgReporter, --'Valid values: A = Academic, H = Hybrid, P = Program; Default value (if no record or null value): A'
    'U' publicOrPrivateInstitution, --'Valid values: U = Public, R = Private; Default value (if no record or null value): U'
    CAST('2010-08-31' as DATE) earliestStatusDate, --BS4YrDate
    CAST('2013-08-31' as DATE) midStatusDate, --(same as Grad Rates) "150% of normal time to completion or August 31, 2018 (whichever was earlier)"
    CAST('2014-08-31' as DATE) latestStatusDate,  --151% - 200% (September 1, 2018 through August 31, 2020)
--***** start survey-specific mods
	CAST('2010-10-15' AS DATE) cohortDateEnd, --as of October 15, 2012 (or the institution's official fall reporting date) 
...
where awardRn <= 1
--***** start survey-specific mods
--    and awardedAwardLevel = 'Bachelors Degree' --Not used in GR200 V2
--***** end survey-specific mods
),
...
select 'A' part,
    ...
    sum(completer200) field2, --Completers in year 4 <br/>(completed a program between 151% and 200% of normal time to completion)	0 to 999999
