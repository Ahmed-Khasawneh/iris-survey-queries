...
----------- 		--------------------	-------------   	---------------------------------------------------------------------------
20210129            jhanicak                                    PF-1925 Remove old IPEDSReportingPeriod fields (runtime: prod 5m 58s test 6m 34s)
...
--mod from v2 - Part A doesn't contain transfer student level values 2, 16, added "ipedsPartAStudentLevel not in ('2', '16', " to WHERE
