...
-----------------   --------------------	-------------   	-------------------------------------------------
20200810			akhasawneh									initial version 2020-21 revision (PF-1611) (Run time 1m 33s)
20200608            jhanicak          			    		    Initial version (Run time 53s)
	
2020-2021 Changes:	
	Part C - Student Services - Special Learning Opportunities. A change was made to replace the term ‘dual credit’ with 
	‘dual enrollment’. (CHANGE TO FIELD THAT IS NOT INCLUDED IN THE EXPORT FILE. NO CHAGNE NEEDED)
