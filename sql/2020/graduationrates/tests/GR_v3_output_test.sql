...
--if awarded degree program is less than 2 years and within the awarded grad date 100%
        (case when latestStatus = 8 then 1 else 0 end) stat8,
--if awarded degree program is at least 2 years and less than 4 years and within the awarded grad date 100%
        ...
        1 stat10,
        (case when latestStatus = 8 or latestStatus = 11 then 1 else 0 end) stat11, --Completers of programs of less than 2 years within 150% of normal time --all
...
from (
	VALUES
		(8) -- value used to ensure part C prints when no records exist 
