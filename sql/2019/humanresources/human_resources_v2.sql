...
20200702						akhasawneh					ak 20200702			Modify HR report query with standardized view naming/aliasing convention (PF-1533) (Run time 3m 50s)																			
20200701            jhanicak                            Added new Faculty fields filtering and fixed OccCat case stmts PF-1536 (run time 3m 14s)
...
--***** start survey-specific mods
			...
			--facappENT.tenureStatus tenureStatus,  --n/a for v2
...
select cohortemp.personId personId,
	...
	--cohortemp.tenureStatus tenureStatus, --n/a for v2
	cohortemp.nonTenureContractLength nonTenureContractLength,
	(case --when cohortemp.tenureStatus = 'Tenured' then 1 --n/a for v2
		--when cohortemp.tenureStatus = 'On Tenure Track' then 2 --n/a for v2
...
from (
    VALUES
		--(1), --Tenured (required if the school has tenure system) --n/a for v2
		--(2), --On tenure track (required if the school has tenure system) --n/a for v2
