...
select '2122' surveyYear, 
	...
	CAST('2015-07-01' AS DATE) reportingDateStart,
	CAST('2021-08-31' AS DATE) reportingDateEnd,
	'201610' termCode, --Fall 2014
	'1' partOfTermCode, 
	CAST('2015-09-10' AS DATE) censusDate,
    ...
    CAST('2016-05-30' as DATE) financialAidEndDate, --For GR report: only aid for first year of enrollment(July 1 - June 30)
    CAST('2019-08-31' as DATE) earliestStatusDate, --BS4YrDate
    CAST('2020-08-31' as DATE) midStatusDate, --BS5YrDate
    CAST('2021-08-31' as DATE) latestStatusDate, --BS6YrDate
--***** start survey-specific mods
	CAST('2016-08-31' AS DATE) cohortDateEnd,
    'Fall' surveySection,
	'000000' ncSchoolCode,
    '00' ncBranchCode,
...
select '2122' surveyYear, 
	...
	'1' partOfTermCode, 
	CAST('2015-06-01' AS DATE) censusDate,
	'M' genderForUnknown,   --'Valid values: M = Male, F = Female; Default value (if no record or null value): M'
	'F' genderForNonBinary, --'Valid values: M = Male, F = Female; Default value (if no record or null value): F'
    'CR' instructionalActivityType, --'Valid values: CR = Credit, CL = Clock, B = Both; Default value (if no record or null value): CR'
    'A' acadOrProgReporter, --'Valid values: A = Academic, H = Hybrid, P = Program; Default value (if no record or null value): A'
