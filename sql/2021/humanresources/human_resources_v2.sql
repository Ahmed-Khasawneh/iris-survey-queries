...
-----------------   ----------------    -------------   ----------------------------------------------------------------------
20210909            akhasawneh                 			Initial version - 1m 58s (prod), 1m 49s (test)
********************/
...
select '2122' surveyYear, 
	...
	CAST('2020-11-01' AS DATE) reportingDateStart, --newHireStartDate
	CAST('2021-10-31' AS DATE) reportingDateEnd, --newHireendDate
    ...
    CAST('2021-11-01' AS DATE) asOfDate,
...
select *,
--New Hires between 11/01/2020 and 10/31/2021
    case when (hireDate >= reportingDateStart and hireDate <= reportingDateEnd) then 1 
        else 0 
    end isNewHire,
--Current employees as-of 11/01/2021
