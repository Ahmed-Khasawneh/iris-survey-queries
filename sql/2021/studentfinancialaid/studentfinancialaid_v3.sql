...
/*******************************************************************
 ...
 full or partial term that starts within the academic year 7/1/2020 thru 6/30/21
  ------------------------------------------------------------------
...
--Valid values
--Academic Years: 1=academic year 2020-21, 2=academic year 2018-19, 3=academic year 2017-18. If you have previously reported prior year values to IPEDS, report only YEAR=1.
--Number of students: 0-999999
--       For public institutions, include only those students paying the in-state or in-district tuition rate.
--       For program reporters, include only those students enrolled in the institution's largest program.
