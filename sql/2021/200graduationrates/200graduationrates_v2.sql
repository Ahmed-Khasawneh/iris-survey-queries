...
- COHORT - Only cares about Bachelor's degree seeking/full time/first time in the cohort.
    - Academic Reporters - as of October 15 (or the institution's official fall reporting date) 
    - Program Reporters - between September 1 and August 31
...
- REPORTING PERIOD - July 01 through August 31.
...
line 8, report the number of students who completed a program (including eligible transfer-preparatory programs; as outlined in the instructions for the Graduation Rates survey component) within the period of 151% to 200% of normal time.
    - exclusions between 151% and 200% completion time.
        * use the same logic for 150% dates. (September 1 through August 31 as hard end points)
...
select '2122' surveyYear, 
	...
	CAST('2017-07-01' AS DATE) reportingDateStart,
	CAST('2021-08-31' AS DATE) reportingDateEnd,
	'201710' termCode, --Fall
	'1' partOfTermCode, 
	CAST('2017-09-10' AS DATE) censusDate,
    ...
    CAST('2017-08-31' as DATE) earliestStatusDate,
    CAST('2020-08-31' as DATE) midStatusDate, --(same as Grad Rates) "150% of normal time to completion or August 31 (whichever was earlier)"
    CAST('2021-08-31' as DATE) latestStatusDate, --151% - 200% (September 1 through August 31)
--***** start survey-specific mods
	CAST('2017-10-15' AS DATE) cohortDateEnd, --as of October 15 (or the institution's official fall reporting date) 
    'Fall' surveySection
...
select '2122' surveyYear, 
	...
	CAST('2017-07-01' AS DATE) reportingDateStart,
	CAST('2021-08-31' AS DATE) reportingDateEnd,
	'201630' termCode, --Fall
	'1' partOfTermCode, 
	CAST('2017-08-01' AS DATE) censusDate,
	'M' genderForUnknown,   --'Valid values: M = Male, F = Female; Default value (if no record or null value): M'
	'F' genderForNonBinary, --'Valid values: M = Male, F = Female; Default value (if no record or null value): F'
    'CR' instructionalActivityType, --'Valid values: CR = Credit, CL = Clock, B = Both; Default value (if no record or null value): CR'
    'A' acadOrProgReporter, --'Valid values: A = Academic, H = Hybrid, P = Program; Default value (if no record or null value): A'
